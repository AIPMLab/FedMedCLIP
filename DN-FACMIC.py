...
def main(Location, dataset, method):
    ...
    parser.add_argument('--dataset', type=str, default='brain_ICH')
    ...
    parser.add_argument('--test_envs', type=int, nargs='+', default=[20])
    ...
    server_model.initdgatal(test_loaders[20])
...
if __name__ == '__main__':
    ...
    Location = './SavedModel/brain_ICH/AAAI2026/20clients/FACMIC/ViT-B-32/lr=5e-4/'
    method = '/FACMIC/ViT-B-32/lr=5e-4/'
    dataset = '/brain_ICH/AAAI2026/20clients/'
